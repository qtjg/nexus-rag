        ...
        <section className="nexus-glow-panel min-h-[650px] overflow-hidden rounded-3xl">
          ...
          <div className="flex min-h-[530px] flex-col">
            <div className="flex-1 space-y-5 px-5 py-7 sm:px-7">
              {workspace.isLoading ? <div role="status" aria-live="polite" className="flex h-full items-center justify-center gap-3 text-sm text-slate-500"><Loader2 className="size-4 animate-spin text-cyan-300" /> Preparing access scope</div> : messages.length === 0 ? (
